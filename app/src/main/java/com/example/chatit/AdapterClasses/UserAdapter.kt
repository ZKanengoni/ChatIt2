...
import com.example.chatit.MessageChatActivity
        ...
        ) : RecyclerView.Adapter<UserAdapter.ViewHolder?>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, i: Int) {
        ...
        Picasso.get().load(user?.getProfile()).placeholder(R.drawable.profile_user).into(holder.profileImageView)
...
//                    mContext.startActivity(intent)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)
    {
        ...
        init {
            ...
            oflineTxt = itemView.findViewById(R.id.image_offline)
