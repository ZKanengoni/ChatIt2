...
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        usersRefrence = FirebaseDatabase.getInstance("https://chatit-61581-default-rtdb.europe-west1.firebasedatabase.app/").reference.child("Users").child(firebaseUser!!.uid)
